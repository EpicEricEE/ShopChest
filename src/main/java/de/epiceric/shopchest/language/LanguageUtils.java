...
public class LanguageUtils {
    ...
    public static void load() {
        ...
        messages.add(new LocalizedMessage(LocalizedMessage.Message.NOT_OWNER_OF_CURRENT_PLOT, langConfig.getString("messages.not-owner-of-plot", "&cYou are not the owner of this plot!")));
    }
