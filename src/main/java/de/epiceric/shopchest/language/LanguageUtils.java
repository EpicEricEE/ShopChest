...
public class LanguageUtils {
    ...
    public static void load() {
        ...
        itemNames.add(new ItemName(Material.OAK_WOOD, langConfig.getString("tile.wood.oak.name", "Oak Wood Planks")));
        itemNames.add(new ItemName(Material.SPRUCE_WOOD, langConfig.getString("tile.wood.spruce.name", "Spruce Wood Planks")));
        itemNames.add(new ItemName(Material.BIRCH_WOOD, langConfig.getString("tile.wood.birch.name", "Birch Wood Planks")));
        itemNames.add(new ItemName(Material.JUNGLE_WOOD, langConfig.getString("tile.wood.jungle.name", "Jungle Wood Planks")));
        itemNames.add(new ItemName(Material.ACACIA_WOOD, langConfig.getString("tile.wood.acacia.name", "Acacia Wood Planks")));
        itemNames.add(new ItemName(Material.DARK_OAK_WOOD, langConfig.getString("tile.wood.big_oak.name", "Dark Oak Wood Planks")));
        itemNames.add(new ItemName(Material.OAK_SAPLING, langConfig.getString("tile.sapling.oak.name", "Oak Sapling")));
        itemNames.add(new ItemName(Material.SPRUCE_SAPLING, langConfig.getString("tile.sapling.spruce.name", "Spruce Sapling")));
        itemNames.add(new ItemName(Material.BIRCH_SAPLING, langConfig.getString("tile.sapling.birch.name", "Birch Sapling")));
        itemNames.add(new ItemName(Material.JUNGLE_SAPLING, langConfig.getString("tile.sapling.jungle.name", "Jungle Sapling")));
        itemNames.add(new ItemName(Material.ACACIA_SAPLING, langConfig.getString("tile.sapling.acacia.name", "Acacia Sapling")));
        itemNames.add(new ItemName(Material.DARK_OAK_SAPLING, langConfig.getString("tile.sapling.big_oak.name", "Dark Oak Sapling")));
        ...
        itemNames.add(new ItemName(Material.RED_SAND, langConfig.getString("tile.sand.red.name", "Red Sand")));
        ...
        itemNames.add(new ItemName(Material.OAK_WOOD, langConfig.getString("tile.log.oak.name", "Oak Wood")));
        itemNames.add(new ItemName(Material.SPRUCE_WOOD, langConfig.getString("tile.log.spruce.name", "Spruce Wood")));
        itemNames.add(new ItemName(Material.BIRCH_WOOD, langConfig.getString("tile.log.birch.name", "Birch Wood")));
        itemNames.add(new ItemName(Material.JUNGLE_WOOD, langConfig.getString("tile.log.jungle.name", "Jungle Wood")));
        itemNames.add(new ItemName(Material.OAK_LEAVES, langConfig.getString("tile.leaves.oak.name", "Oak Leaves")));
        itemNames.add(new ItemName(Material.SPRUCE_LEAVES, langConfig.getString("tile.leaves.spruce.name", "Spruce Leaves")));
        itemNames.add(new ItemName(Material.BIRCH_LEAVES, langConfig.getString("tile.leaves.birch.name", "Birch Leaves")));
        itemNames.add(new ItemName(Material.JUNGLE_LEAVES, langConfig.getString("tile.leaves.jungle.name", "Jungle Leaves")));
        itemNames.add(new ItemName(Material.SPONGE, langConfig.getString("tile.sponge.dry.name", "Sponge")));
        itemNames.add(new ItemName(Material.WET_SPONGE, langConfig.getString("tile.sponge.wet.name", "Wet Sponge")));
        ...
        itemNames.add(new ItemName(Material.STICKY_PISTON, langConfig.getString("tile.pistonStickyBase.name", "Sticky Piston")));
        itemNames.add(new ItemName(Material.COBWEB, langConfig.getString("tile.web.name", "Web")));
        itemNames.add(new ItemName(Material.TALL_GRASS, langConfig.getString("tile.tallgrass.shrub.name", "Shrub")));
        itemNames.add(new ItemName(Material.TALL_GRASS, 1, langConfig.getString("tile.tallgrass.grass.name", "Grass")));
        itemNames.add(new ItemName(Material.TALL_GRASS, 2, langConfig.getString("tile.tallgrass.fern.name", "Fern")));
        itemNames.add(new ItemName(Material.DEAD_BUSH, langConfig.getString("tile.deadbush.name", "Dead Bush")));
        itemNames.add(new ItemName(Material.PISTON, langConfig.getString("tile.pistonBase.name", "Piston")));
        itemNames.add(new ItemName(Material.WHITE_WOOL, langConfig.getString("tile.cloth.white.name", "White Wool")));
        itemNames.add(new ItemName(Material.ORANGE_WOOL, langConfig.getString("tile.cloth.orange.name", "Orange Wool")));
        itemNames.add(new ItemName(Material.MAGENTA_WOOL, langConfig.getString("tile.cloth.magenta.name", "Magenta Wool")));
        itemNames.add(new ItemName(Material.LIGHT_BLUE_WOOL, langConfig.getString("tile.cloth.lightBlue.name", "Light Blue Wool")));
        itemNames.add(new ItemName(Material.YELLOW_WOOL, langConfig.getString("tile.cloth.yellow.name", "Yellow Wool")));
        itemNames.add(new ItemName(Material.LIME_WOOL, langConfig.getString("tile.cloth.lime.name", "Lime Wool")));
        itemNames.add(new ItemName(Material.PINK_WOOL, langConfig.getString("tile.cloth.pink.name", "Pink Wool")));
        itemNames.add(new ItemName(Material.GRAY_WOOL, langConfig.getString("tile.cloth.gray.name", "Gray Wool")));
        itemNames.add(new ItemName(Material.LIGHT_GRAY_WOOL, langConfig.getString("tile.cloth.silver.name", "Light Gray Wool")));
        itemNames.add(new ItemName(Material.CYAN_WOOL, langConfig.getString("tile.cloth.cyan.name", "Cyan Wool")));
        itemNames.add(new ItemName(Material.PURPLE_WOOL, langConfig.getString("tile.cloth.purple.name", "Purple Wool")));
        itemNames.add(new ItemName(Material.BLUE_WOOL, langConfig.getString("tile.cloth.blue.name", "Blue Wool")));
        itemNames.add(new ItemName(Material.BROWN_WOOL, langConfig.getString("tile.cloth.brown.name", "Brown Wool")));
        itemNames.add(new ItemName(Material.GREEN_WOOL, langConfig.getString("tile.cloth.green.name", "Green Wool")));
        itemNames.add(new ItemName(Material.RED_WOOL, langConfig.getString("tile.cloth.red.name", "Red Wool")));
        itemNames.add(new ItemName(Material.BLACK_WOOL, langConfig.getString("tile.cloth.black.name", "Black Wool")));
        itemNames.add(new ItemName(Material.DANDELION, langConfig.getString("tile.flower1.dandelion.name", "Dandelion")));
        itemNames.add(new ItemName(Material.POPPY, langConfig.getString("tile.flower2.poppy.name", "Poppy")));
        itemNames.add(new ItemName(Material.BLUE_ORCHID, langConfig.getString("tile.flower2.blueOrchid.name", "Blue Orchid")));
        itemNames.add(new ItemName(Material.ALLIUM, langConfig.getString("tile.flower2.allium.name", "Allium")));
        itemNames.add(new ItemName(Material.AZURE_BLUET, langConfig.getString("tile.flower2.houstonia.name", "Azure Bluet")));
        itemNames.add(new ItemName(Material.RED_TULIP, langConfig.getString("tile.flower2.tulipRed.name", "Red Tulip")));
        itemNames.add(new ItemName(Material.ORANGE_TULIP, langConfig.getString("tile.flower2.tulipOrange.name", "Orange Tulip")));
        itemNames.add(new ItemName(Material.WHITE_TULIP, langConfig.getString("tile.flower2.tulipWhite.name", "White Tulip")));
        itemNames.add(new ItemName(Material.PINK_TULIP, langConfig.getString("tile.flower2.tulipPink.name", "Pink Tulip")));
        itemNames.add(new ItemName(Material.OXEYE_DAISY, langConfig.getString("tile.flower2.oxeyeDaisy.name", "Oxeye Daisy")));
        ...
        itemNames.add(new ItemName(Material.STONE_SLAB, langConfig.getString("tile.stoneSlab.stone.name", "Stone Slab")));
        itemNames.add(new ItemName(Material.SANDSTONE_SLAB, langConfig.getString("tile.stoneSlab.sand.name", "Sandstone Slab")));
        itemNames.add(new ItemName(Material.ACACIA_SLAB, langConfig.getString("tile.stoneSlab.wood.name", "Wooden Slab")));
        // #todo Add every wood slab
        itemNames.add(new ItemName(Material.COBBLESTONE_SLAB, langConfig.getString("tile.stoneSlab.cobble.name", "Cobblestone Slab")));
        itemNames.add(new ItemName(Material.BRICK_SLAB, langConfig.getString("tile.stoneSlab.brick.name", "Brick Slab")));
        itemNames.add(new ItemName(Material.STONE_BRICK_SLAB, langConfig.getString("tile.stoneSlab.smoothStoneBrick.name", "Stone Brick Slab")));
        itemNames.add(new ItemName(Material.NETHER_BRICK, langConfig.getString("tile.stoneSlab.netherBrick.name", "Nether Brick Slab")));
        itemNames.add(new ItemName(Material.QUARTZ_SLAB, langConfig.getString("tile.stoneSlab.quartz.name", "Quartz Slab")));
        ...
        itemNames.add(new ItemName(Material.SPAWNER, langConfig.getString("tile.mobSpawner.name", "Mob Spawner")));
        itemNames.add(new ItemName(Material.OAK_STAIRS, langConfig.getString("tile.stairsWood.name", "Oak Wood Stairs")));
        ...
        itemNames.add(new ItemName(Material.CRAFTING_TABLE, langConfig.getString("tile.workbench.name", "Crafting Table")));
        itemNames.add(new ItemName(Material.FARMLAND, langConfig.getString("tile.farmland.name", "Farmland")));
        ...
        itemNames.add(new ItemName(Material.ACTIVATOR_RAIL, langConfig.getString("tile.rail.name", "Rail")));
        ...
        itemNames.add(new ItemName(Material.STONE_PRESSURE_PLATE, langConfig.getString("tile.pressurePlateStone.name", "Stone Pressure Plate")));
        /// #todo Add every wood pressure plate
        itemNames.add(new ItemName(Material.OAK_PRESSURE_PLATE, langConfig.getString("tile.pressurePlateWood.name", "Wooden Pressure Plate")));
        itemNames.add(new ItemName(Material.REDSTONE_ORE, langConfig.getString("tile.oreRedstone.name", "Redstone Ore")));
        itemNames.add(new ItemName(Material.REDSTONE_TORCH, langConfig.getString("tile.notGate.name", "Redstone Torch")));
        ...
        itemNames.add(new ItemName(Material.OAK_FENCE, langConfig.getString("tile.fence.name", "Oak Fence")));
        // #todo Add fence names
        ...
        itemNames.add(new ItemName(Material.NETHER_PORTAL, langConfig.getString("tile.portal.name", "Portal")));
        itemNames.add(new ItemName(Material.JACK_O_LANTERN, langConfig.getString("tile.litpumpkin.name", "Jack o'Lantern")));
        itemNames.add(new ItemName(Material.WHITE_STAINED_GLASS, langConfig.getString("tile.stainedGlass.white.name", "White Stained Glass")));
        itemNames.add(new ItemName(Material.ORANGE_STAINED_GLASS, langConfig.getString("tile.stainedGlass.orange.name", "Orange Stained Glass")));
        itemNames.add(new ItemName(Material.MAGENTA_STAINED_GLASS, langConfig.getString("tile.stainedGlass.magenta.name", "Magenta Stained Glass")));
        itemNames.add(new ItemName(Material.LIGHT_BLUE_STAINED_GLASS, langConfig.getString("tile.stainedGlass.lightBlue.name", "Light Blue Stained Glass")));
        itemNames.add(new ItemName(Material.YELLOW_STAINED_GLASS, langConfig.getString("tile.stainedGlass.yellow.name", "Yellow Stained Glass")));
        itemNames.add(new ItemName(Material.LIME_STAINED_GLASS, langConfig.getString("tile.stainedGlass.lime.name", "Lime Stained Glass")));
        itemNames.add(new ItemName(Material.PINK_STAINED_GLASS, langConfig.getString("tile.stainedGlass.pink.name", "Pink Stained Glass")));
        itemNames.add(new ItemName(Material.GRAY_STAINED_GLASS, langConfig.getString("tile.stainedGlass.gray.name", "Gray Stained Glass")));
        itemNames.add(new ItemName(Material.LIGHT_GRAY_STAINED_GLASS, langConfig.getString("tile.stainedGlass.silver.name", "Light Gray Stained Glass")));
        itemNames.add(new ItemName(Material.CYAN_STAINED_GLASS, langConfig.getString("tile.stainedGlass.cyan.name", "Cyan Stained Glass")));
        itemNames.add(new ItemName(Material.PURPLE_STAINED_GLASS, langConfig.getString("tile.stainedGlass.purple.name", "Purple Stained Glass")));
        itemNames.add(new ItemName(Material.BLUE_STAINED_GLASS, langConfig.getString("tile.stainedGlass.blue.name", "Blue Stained Glass")));
        itemNames.add(new ItemName(Material.BROWN_STAINED_GLASS, langConfig.getString("tile.stainedGlass.brown.name", "Brown Stained Glass")));
        itemNames.add(new ItemName(Material.GREEN_STAINED_GLASS, langConfig.getString("tile.stainedGlass.green.name", "Green Stained Glass")));
        itemNames.add(new ItemName(Material.RED_STAINED_GLASS, langConfig.getString("tile.stainedGlass.red.name", "Red Stained Glass")));
        itemNames.add(new ItemName(Material.BLACK_STAINED_GLASS, langConfig.getString("tile.stainedGlass.black.name", "Black Stained Glass")));
        itemNames.add(new ItemName(Material.OAK_TRAPDOOR, langConfig.getString("tile.trapdoor.name", "Wooden Trapdoor")));
        // #todo Evaluate adding wooden trapdoors
        itemNames.add(new ItemName(Material.INFESTED_STONE, langConfig.getString("tile.monsterStoneEgg.stone.name", "Stone Monster Egg")));
        itemNames.add(new ItemName(Material.INFESTED_COBBLESTONE, langConfig.getString("tile.monsterStoneEgg.cobble.name", "Cobblestone Monster Egg")));
        itemNames.add(new ItemName(Material.INFESTED_STONE_BRICKS, langConfig.getString("tile.monsterStoneEgg.brick.name", "Stone Brick Monster Egg")));
        itemNames.add(new ItemName(Material.INFESTED_MOSSY_STONE_BRICKS, langConfig.getString("tile.monsterStoneEgg.mossybrick.name", "Mossy Stone Brick Monster Egg")));
        itemNames.add(new ItemName(Material.INFESTED_CRACKED_STONE_BRICKS, langConfig.getString("tile.monsterStoneEgg.crackedbrick.name", "Cracked Stone Brick Monster Egg")));
        itemNames.add(new ItemName(Material.INFESTED_CHISELED_STONE_BRICKS, langConfig.getString("tile.monsterStoneEgg.chiseledbrick.name", "Chiseled Stone Brick Monster Egg")));
        itemNames.add(new ItemName(Material.STONE_BRICKS, langConfig.getString("tile.stonebricksmooth.default.name", "Stone Bricks")));
        itemNames.add(new ItemName(Material.MOSSY_STONE_BRICKS, langConfig.getString("tile.stonebricksmooth.mossy.name", "Mossy Stone Bricks")));
        itemNames.add(new ItemName(Material.CRACKED_STONE_BRICKS, langConfig.getString("tile.stonebricksmooth.cracked.name", "Cracked Stone Bricks")));
        itemNames.add(new ItemName(Material.CHISELED_STONE_BRICKS, langConfig.getString("tile.stonebricksmooth.chiseled.name", "Chiseled Stone Bricks")));
        itemNames.add(new ItemName(Material.RED_MUSHROOM_BLOCK, langConfig.getString("tile.redmushroom.name", "Red Mushroom")));
        itemNames.add(new ItemName(Material.BROWN_MUSHROOM_BLOCK, langConfig.getString("tile.brownmushroom.name", "Brown Mushroom")));
        itemNames.add(new ItemName(Material.RED_MUSHROOM, langConfig.getString("tile.mushroom.name", "Mushroom")));
        itemNames.add(new ItemName(Material.IRON_BARS, langConfig.getString("tile.fenceIron.name", "Iron Bars")));
        itemNames.add(new ItemName(Material.GLASS_PANE, langConfig.getString("tile.thinGlass.name", "Glass Pane")));
        itemNames.add(new ItemName(Material.MELON, langConfig.getString("tile.melon.name", "Melon")));
        itemNames.add(new ItemName(Material.VINE, langConfig.getString("tile.vine.name", "Vines")));
        itemNames.add(new ItemName(Material.OAK_FENCE_GATE, langConfig.getString("tile.fenceGate.name", "Oak Fence Gate")));
        // #todo Consider adding wooden gates
        itemNames.add(new ItemName(Material.BRICK_STAIRS, langConfig.getString("tile.stairsBrick.name", "Brick Stairs")));
        itemNames.add(new ItemName(Material.STONE_BRICK_STAIRS, langConfig.getString("tile.stairsStoneBrickSmooth.name", "Stone Brick Stairs")));
        itemNames.add(new ItemName(Material.MYCELIUM, langConfig.getString("tile.mycel.name", "Mycelium")));
        itemNames.add(new ItemName(Material.LILY_PAD, langConfig.getString("tile.waterlily.name", "Lily Pad")));
        itemNames.add(new ItemName(Material.NETHER_BRICK, langConfig.getString("tile.netherBrick.name", "Nether Brick")));
        itemNames.add(new ItemName(Material.NETHER_BRICK_FENCE, langConfig.getString("tile.netherFence.name", "Nether Brick Fence")));
        ...
        itemNames.add(new ItemName(Material.ENCHANTING_TABLE, langConfig.getString("tile.enchantmentTable.name", "Enchantment Table")));
        itemNames.add(new ItemName(Material.END_PORTAL_FRAME, langConfig.getString("tile.endPortalFrame.name", "End Portal Frame")));
        itemNames.add(new ItemName(Material.END_STONE, langConfig.getString("tile.whiteStone.name", "End Stone")));
        itemNames.add(new ItemName(Material.DRAGON_EGG, langConfig.getString("tile.dragonEgg.name", "Dragon Egg")));
        itemNames.add(new ItemName(Material.REDSTONE_LAMP, langConfig.getString("tile.redstoneLight.name", "Redstone Lamp")));
        itemNames.add(new ItemName(Material.OAK_SLAB, langConfig.getString("tile.woodSlab.oak.name", "Oak Wood Slab")));
        itemNames.add(new ItemName(Material.SPRUCE_SLAB, langConfig.getString("tile.woodSlab.spruce.name", "Spruce Wood Slab")));
        itemNames.add(new ItemName(Material.BIRCH_SLAB, langConfig.getString("tile.woodSlab.birch.name", "Birch Wood Slab")));
        itemNames.add(new ItemName(Material.JUNGLE_SLAB, langConfig.getString("tile.woodSlab.jungle.name", "Jungle Wood Slab")));
        itemNames.add(new ItemName(Material.ACACIA_SLAB, langConfig.getString("tile.woodSlab.acacia.name", "Acacia Wood Slab")));
        itemNames.add(new ItemName(Material.DARK_OAK_SLAB, langConfig.getString("tile.woodSlab.big_oak.name", "Dark Oak Wood Slab")));
        ...
        itemNames.add(new ItemName(Material.SPRUCE_STAIRS, langConfig.getString("tile.stairsWoodSpruce.name", "Spruce Wood Stairs")));
        itemNames.add(new ItemName(Material.BIRCH_STAIRS, langConfig.getString("tile.stairsWoodBirch.name", "Birch Wood Stairs")));
        itemNames.add(new ItemName(Material.JUNGLE_STAIRS, langConfig.getString("tile.stairsWoodJungle.name", "Jungle Wood Stairs")));
        itemNames.add(new ItemName(Material.COMMAND_BLOCK, langConfig.getString("tile.commandBlock.name", "Command Block")));
        itemNames.add(new ItemName(Material.BEACON, langConfig.getString("tile.beacon.name", "Beacon")));
        itemNames.add(new ItemName(Material.COBBLESTONE_WALL, langConfig.getString("tile.cobbleWall.normal.name", "Cobblestone Wall")));
        itemNames.add(new ItemName(Material.MOSSY_COBBLESTONE_WALL, langConfig.getString("tile.cobbleWall.mossy.name", "Mossy Cobblestone Wall")));
        itemNames.add(new ItemName(Material.OAK_BUTTON, langConfig.getString("tile.button.name", "Button")));
        // #todo Consider adding more wooden buttons
        itemNames.add(new ItemName(Material.NETHER_WART, langConfig.getString("tile.netherStalk.name", "Nether Wart")));
        itemNames.add(new ItemName(Material.ANVIL, langConfig.getString("tile.anvil.intact.name", "Anvil")));
        itemNames.add(new ItemName(Material.CHIPPED_ANVIL, langConfig.getString("tile.anvil.slightlyDamaged.name", "Slightly Damaged Anvil")));
        itemNames.add(new ItemName(Material.DAMAGED_ANVIL, langConfig.getString("tile.anvil.veryDamaged.name", "Very Damaged Anvil")));
        itemNames.add(new ItemName(Material.TRAPPED_CHEST, langConfig.getString("tile.chestTrap.name", "Trapped Chest")));
        itemNames.add(new ItemName(Material.LIGHT_WEIGHTED_PRESSURE_PLATE, langConfig.getString("tile.weightedPlate_light.name", "Weighted Pressure Plate (Light)")));
        itemNames.add(new ItemName(Material.HEAVY_WEIGHTED_PRESSURE_PLATE, langConfig.getString("tile.weightedPlate_heavy.name", "Weighted Pressure Plate (Heavy)")));
        ...
        itemNames.add(new ItemName(Material.NETHER_QUARTZ_ORE, langConfig.getString("tile.netherquartz.name", "Nether Quartz Ore")));
        ...
        itemNames.add(new ItemName(Material.WHITE_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.white.name", "White Terracotta")));
        itemNames.add(new ItemName(Material.ORANGE_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.orange.name", "Orange Terracotta")));
        itemNames.add(new ItemName(Material.MAGENTA_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.magenta.name", "Magenta Terracotta")));
        itemNames.add(new ItemName(Material.LIGHT_BLUE_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.lightBlue.name", "Light Blue Terracotta")));
        itemNames.add(new ItemName(Material.YELLOW_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.yellow.name", "Yellow Terracotta")));
        itemNames.add(new ItemName(Material.LIME_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.lime.name", "Lime Terracotta")));
        itemNames.add(new ItemName(Material.PINK_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.pink.name", "Pink Terracotta")));
        itemNames.add(new ItemName(Material.GRAY_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.gray.name", "Gray Terracotta")));
        itemNames.add(new ItemName(Material.LIGHT_GRAY_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.silver.name", "Light Gray Terracotta")));
        itemNames.add(new ItemName(Material.CYAN_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.cyan.name", "Cyan Terracotta")));
        itemNames.add(new ItemName(Material.PURPLE_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.purple.name", "Purple Terracotta")));
        itemNames.add(new ItemName(Material.BLUE_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.blue.name", "Blue Terracotta")));
        itemNames.add(new ItemName(Material.BROWN_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.brown.name", "Brown Terracotta")));
        itemNames.add(new ItemName(Material.GREEN_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.green.name", "Green Terracotta")));
        itemNames.add(new ItemName(Material.RED_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.red.name", "Red Terracotta")));
        itemNames.add(new ItemName(Material.BLACK_TERRACOTTA, langConfig.getString("tile.clayHardenedStained.black.name", "Black Terracotta")));
        itemNames.add(new ItemName(Material.WHITE_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.white.name", "White Stained Glass Pane")));
        itemNames.add(new ItemName(Material.WHITE_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.orange.name", "Orange Stained Glass Pane")));
        itemNames.add(new ItemName(Material.MAGENTA_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.magenta.name", "Magenta Stained Glass Pane")));
        itemNames.add(new ItemName(Material.LIGHT_BLUE_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.lightBlue.name", "Light Blue Stained Glass Pane")));
        itemNames.add(new ItemName(Material.YELLOW_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.yellow.name", "Yellow Stained Glass Pane")));
        itemNames.add(new ItemName(Material.LIME_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.lime.name", "Lime Stained Glass Pane")));
        itemNames.add(new ItemName(Material.PINK_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.pink.name", "Pink Stained Glass Pane")));
        itemNames.add(new ItemName(Material.GRAY_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.gray.name", "Gray Stained Glass Pane")));
        itemNames.add(new ItemName(Material.LIGHT_GRAY_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.silver.name", "Light Gray Stained Glass Pane")));
        itemNames.add(new ItemName(Material.CYAN_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.cyan.name", "Cyan Stained Glass Pane")));
        itemNames.add(new ItemName(Material.PURPLE_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.purple.name", "Purple Stained Glass Pane")));
        itemNames.add(new ItemName(Material.BLUE_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.blue.name", "Blue Stained Glass Pane")));
        itemNames.add(new ItemName(Material.BROWN_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.brown.name", "Brown Stained Glass Pane")));
        itemNames.add(new ItemName(Material.GREEN_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.green.name", "Green Stained Glass Pane")));
        itemNames.add(new ItemName(Material.RED_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.red.name", "Red Stained Glass Pane")));
        itemNames.add(new ItemName(Material.BLACK_STAINED_GLASS_PANE, langConfig.getString("tile.thinStainedGlass.black.name", "Black Stained Glass Pane")));
        itemNames.add(new ItemName(Material.ACACIA_LEAVES, langConfig.getString("tile.leaves.acacia.name", "Acacia Leaves")));
        itemNames.add(new ItemName(Material.DARK_OAK_LEAVES, langConfig.getString("tile.leaves.big_oak.name", "Dark Oak Leaves")));
        itemNames.add(new ItemName(Material.ACACIA_WOOD, langConfig.getString("tile.log.acacia.name", "Acacia Wood")));
        itemNames.add(new ItemName(Material.DARK_OAK_WOOD, langConfig.getString("tile.log.big_oak.name", "Dark Oak Wood")));
        ...
        itemNames.add(new ItemName(Material.PRISMARINE_BRICKS, langConfig.getString("tile.prismarine.bricks.name", "Prismarine Bricks")));
        itemNames.add(new ItemName(Material.DARK_PRISMARINE, langConfig.getString("tile.prismarine.dark.name", "Dark Prismarine")));
        ...
        itemNames.add(new ItemName(Material.WHITE_CARPET, langConfig.getString("tile.woolCarpet.white.name", "White Carpet")));
        itemNames.add(new ItemName(Material.ORANGE_CARPET, langConfig.getString("tile.woolCarpet.orange.name", "Orange Carpet")));
        itemNames.add(new ItemName(Material.MAGENTA_CARPET, langConfig.getString("tile.woolCarpet.magenta.name", "Magenta Carpet")));
        itemNames.add(new ItemName(Material.LIGHT_BLUE_CARPET, langConfig.getString("tile.woolCarpet.lightBlue.name", "Light Blue Carpet")));
        itemNames.add(new ItemName(Material.YELLOW_CARPET, langConfig.getString("tile.woolCarpet.yellow.name", "Yellow Carpet")));
        itemNames.add(new ItemName(Material.LIME_CARPET, langConfig.getString("tile.woolCarpet.lime.name", "Lime Carpet")));
        itemNames.add(new ItemName(Material.PINK_CARPET, langConfig.getString("tile.woolCarpet.pink.name", "Pink Carpet")));
        itemNames.add(new ItemName(Material.GRAY_CARPET, langConfig.getString("tile.woolCarpet.gray.name", "Gray Carpet")));
        itemNames.add(new ItemName(Material.LIGHT_GRAY_CARPET, langConfig.getString("tile.woolCarpet.silver.name", "Light Gray Carpet")));
        itemNames.add(new ItemName(Material.CYAN_CARPET, langConfig.getString("tile.woolCarpet.cyan.name", "Cyan Carpet")));
        itemNames.add(new ItemName(Material.PURPLE_CARPET, langConfig.getString("tile.woolCarpet.purple.name", "Purple Carpet")));
        itemNames.add(new ItemName(Material.BLUE_CARPET, langConfig.getString("tile.woolCarpet.blue.name", "Blue Carpet")));
        itemNames.add(new ItemName(Material.BROWN_CARPET, langConfig.getString("tile.woolCarpet.brown.name", "Brown Carpet")));
        itemNames.add(new ItemName(Material.GREEN_CARPET, langConfig.getString("tile.woolCarpet.green.name", "Green Carpet")));
        itemNames.add(new ItemName(Material.RED_CARPET, langConfig.getString("tile.woolCarpet.red.name", "Red Carpet")));
        itemNames.add(new ItemName(Material.BLACK_CARPET, langConfig.getString("tile.woolCarpet.black.name", "Black Carpet")));
        itemNames.add(new ItemName(Material.TERRACOTTA, langConfig.getString("tile.clayHardened.name", "Hardened Clay")));
        ...
        itemNames.add(new ItemName(Material.SUNFLOWER, langConfig.getString("tile.doublePlant.sunflower.name", "Sunflower")));
        itemNames.add(new ItemName(Material.LILAC, langConfig.getString("tile.doublePlant.syringa.name", "Lilac")));
        itemNames.add(new ItemName(Material.TALL_GRASS, langConfig.getString("tile.doublePlant.grass.name", "Double Tallgrass")));
        itemNames.add(new ItemName(Material.LARGE_FERN, langConfig.getString("tile.doublePlant.fern.name", "Large Fern")));
        itemNames.add(new ItemName(Material.ROSE_BUSH, langConfig.getString("tile.doublePlant.rose.name", "Rose Bush")));
        itemNames.add(new ItemName(Material.PEONY, langConfig.getString("tile.doublePlant.paeonia.name", "Peony")));
        itemNames.add(new ItemName(Material.RED_SANDSTONE, langConfig.getString("tile.redSandStone.default.name", "Red Sandstone")));
        itemNames.add(new ItemName(Material.CHISELED_RED_SANDSTONE, langConfig.getString("tile.redSandStone.chiseled.name", "Chiseled Red Sandstone")));
        itemNames.add(new ItemName(Material.SMOOTH_RED_SANDSTONE, langConfig.getString("tile.redSandStone.smooth.name", "Smooth Red Sandstone")));
        ...
        itemNames.add(new ItemName(Material.RED_SANDSTONE_SLAB, langConfig.getString("tile.stoneSlab2.red_sandstone.name", "Red Sandstone Slab")));
        ...
        if (Utils.getMajorVersion() >= 9) {
            ...
            itemNames.add(new ItemName(Material.END_STONE_BRICKS, langConfig.getString("tile.endBricks.name", "End Stone Bricks")));
            itemNames.add(new ItemName(Material.GRASS_PATH, langConfig.getString("tile.grassPath.name", "Grass Path")));
            itemNames.add(new ItemName(Material.REPEATING_COMMAND_BLOCK, langConfig.getString("tile.repeatingCommandBlock.name", "Repeating Command Block")));
            itemNames.add(new ItemName(Material.CHAIN_COMMAND_BLOCK, langConfig.getString("tile.chainCommandBlock.name", "Chain Command Block")));
        ...
        if (Utils.getMajorVersion() >= 10) {
            ...
            itemNames.add(new ItemName(Material.MAGMA_BLOCK, langConfig.getString("tile.magma.name", "Magma Block")));
            itemNames.add(new ItemName(Material.NETHER_WART_BLOCK, langConfig.getString("tile.netherWartBlock.name", "Nether Wart Block")));
            itemNames.add(new ItemName(Material.RED_NETHER_BRICKS, langConfig.getString("tile.redNetherBrick.name", "Red Nether Brick")));
        ...
        if (Utils.getMajorVersion() >= 11) {
            ...
            itemNames.add(new ItemName(Material.LIGHT_GRAY_SHULKER_BOX, langConfig.getString("tile.shulkerBoxSilver.name", "Light Gray Shulker Box")));
        ...
        if (Utils.getMajorVersion() >= 12) {
            ...
            itemNames.add(new ItemName(Material.WHITE_CONCRETE, langConfig.getString("tile.concrete.white.name", "White Concrete")));
            itemNames.add(new ItemName(Material.ORANGE_CONCRETE, langConfig.getString("tile.concrete.orange.name", "Orange Concrete")));
            itemNames.add(new ItemName(Material.MAGENTA_CONCRETE, langConfig.getString("tile.concrete.magenta.name", "Magenta Concrete")));
            itemNames.add(new ItemName(Material.LIGHT_BLUE_CONCRETE, langConfig.getString("tile.concrete.lightBlue.name", "Light Blue Concrete")));
            itemNames.add(new ItemName(Material.YELLOW_CONCRETE, langConfig.getString("tile.concrete.yellow.name", "Yellow Concrete")));
            itemNames.add(new ItemName(Material.LIME_CONCRETE, langConfig.getString("tile.concrete.lime.name", "Lime Concrete")));
            itemNames.add(new ItemName(Material.PINK_CONCRETE, langConfig.getString("tile.concrete.pink.name", "Pink Concrete")));
            itemNames.add(new ItemName(Material.GRAY_CONCRETE, langConfig.getString("tile.concrete.gray.name", "Gray Concrete")));
            itemNames.add(new ItemName(Material.LIGHT_GRAY_CONCRETE, langConfig.getString("tile.concrete.silver.name", "Light Gray Concrete")));
            itemNames.add(new ItemName(Material.CYAN_CONCRETE, langConfig.getString("tile.concrete.cyan.name", "Cyan Concrete")));
            itemNames.add(new ItemName(Material.PURPLE_CONCRETE, langConfig.getString("tile.concrete.purple.name", "Purple Concrete")));
            itemNames.add(new ItemName(Material.BLUE_CONCRETE, langConfig.getString("tile.concrete.blue.name", "Blue Concrete")));
            itemNames.add(new ItemName(Material.BROWN_CONCRETE, langConfig.getString("tile.concrete.brown.name", "Brown Concrete")));
            itemNames.add(new ItemName(Material.GREEN_CONCRETE, langConfig.getString("tile.concrete.green.name", "Green Concrete")));
            itemNames.add(new ItemName(Material.RED_CONCRETE, langConfig.getString("tile.concrete.red.name", "Red Concrete")));
            itemNames.add(new ItemName(Material.BLACK_CONCRETE, langConfig.getString("tile.concrete.black.name", "Black Concrete")));
            itemNames.add(new ItemName(Material.WHITE_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.white.name", "White Concrete Powder")));
            itemNames.add(new ItemName(Material.ORANGE_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.orange.name", "Orange Concrete Powder")));
            itemNames.add(new ItemName(Material.MAGENTA_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.magenta.name", "Magenta Concrete Powder")));
            itemNames.add(new ItemName(Material.LIGHT_BLUE_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.lightBlue.name", "Light Blue Concrete Powder")));
            itemNames.add(new ItemName(Material.YELLOW_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.yellow.name", "Yellow Concrete Powder")));
            itemNames.add(new ItemName(Material.LIME_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.lime.name", "Lime Concrete Powder")));
            itemNames.add(new ItemName(Material.PINK_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.pink.name", "Pink Concrete Powder")));
            itemNames.add(new ItemName(Material.GRAY_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.gray.name", "Gray Concrete Powder")));
            itemNames.add(new ItemName(Material.LIGHT_GRAY_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.silver.name", "Light Gray Concrete Powder")));
            itemNames.add(new ItemName(Material.CYAN_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.cyan.name", "Cyan Concrete Powder")));
            itemNames.add(new ItemName(Material.PURPLE_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.purple.name", "Purple Concrete Powder")));
            itemNames.add(new ItemName(Material.BLUE_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.blue.name", "Blue Concrete Powder")));
            itemNames.add(new ItemName(Material.BROWN_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.brown.name", "Brown Concrete Powder")));
            itemNames.add(new ItemName(Material.GREEN_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.green.name", "Green Concrete Powder")));
            itemNames.add(new ItemName(Material.RED_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.red.name", "Red Concrete Powder")));
            itemNames.add(new ItemName(Material.BLACK_CONCRETE_POWDER, langConfig.getString("tile.concretePowder.black.name", "Black Concrete Powder")));
            ...
            itemNames.add(new ItemName(Material.LIGHT_GRAY_GLAZED_TERRACOTTA, langConfig.getString("tile.glazedTerracottaSilver.name", "Light Gray Glazed Terracotta")));
        ...
        // Add Item Names
        itemNames.add(new ItemName(Material.IRON_SHOVEL, langConfig.getString("item.shovelIron.name", "Iron Shovel")));
        ...
        itemNames.add(new ItemName(Material.CHARCOAL, langConfig.getString("item.charcoal.name", "Charcoal")));
        ...
        itemNames.add(new ItemName(Material.WOODEN_SWORD, langConfig.getString("item.swordWood.name", "Wooden Sword")));
        itemNames.add(new ItemName(Material.WOODEN_SHOVEL, langConfig.getString("item.shovelWood.name", "Wooden Shovel")));
        itemNames.add(new ItemName(Material.WOODEN_PICKAXE, langConfig.getString("item.pickaxeWood.name", "Wooden Pickaxe")));
        itemNames.add(new ItemName(Material.WOODEN_AXE, langConfig.getString("item.hatchetWood.name", "Wooden Axe")));
        itemNames.add(new ItemName(Material.STONE_SWORD, langConfig.getString("item.swordStone.name", "Stone Sword")));
        itemNames.add(new ItemName(Material.STONE_SHOVEL, langConfig.getString("item.shovelStone.name", "Stone Shovel")));
        ...
        itemNames.add(new ItemName(Material.DIAMOND_SHOVEL, langConfig.getString("item.shovelDiamond.name", "Diamond Shovel")));
        ...
        itemNames.add(new ItemName(Material.MUSHROOM_STEW, langConfig.getString("item.mushroomStew.name", "Mushroom Stew")));
        itemNames.add(new ItemName(Material.GOLDEN_SWORD, langConfig.getString("item.swordGold.name", "Golden Sword")));
        itemNames.add(new ItemName(Material.GOLDEN_SHOVEL, langConfig.getString("item.shovelGold.name", "Golden Shovel")));
        itemNames.add(new ItemName(Material.GOLDEN_PICKAXE, langConfig.getString("item.pickaxeGold.name", "Golden Pickaxe")));
        itemNames.add(new ItemName(Material.GOLDEN_AXE, langConfig.getString("item.hatchetGold.name", "Golden Axe")));
        ...
        itemNames.add(new ItemName(Material.GUNPOWDER, langConfig.getString("item.sulphur.name", "Gunpowder")));
        itemNames.add(new ItemName(Material.WOODEN_HOE, langConfig.getString("item.hoeWood.name", "Wooden Hoe")));
        ...
        itemNames.add(new ItemName(Material.GOLDEN_HOE, langConfig.getString("item.hoeGold.name", "Golden Hoe")));
        itemNames.add(new ItemName(Material.WHEAT_SEEDS, langConfig.getString("item.seeds.name", "Wheat Seeds")));
        ...
        itemNames.add(new ItemName(Material.GOLDEN_HELMET, langConfig.getString("item.helmetGold.name", "Golden Helmet")));
        itemNames.add(new ItemName(Material.GOLDEN_CHESTPLATE, langConfig.getString("item.chestplateGold.name", "Golden Chestplate")));
        itemNames.add(new ItemName(Material.GOLDEN_LEGGINGS, langConfig.getString("item.leggingsGold.name", "Golden Leggings")));
        itemNames.add(new ItemName(Material.GOLDEN_BOOTS, langConfig.getString("item.bootsGold.name", "Golden Boots")));
        itemNames.add(new ItemName(Material.FLINT, langConfig.getString("item.flint.name", "Flint")));
        itemNames.add(new ItemName(Material.PORKCHOP, langConfig.getString("item.porkchopRaw.name", "Raw Porkchop")));
        itemNames.add(new ItemName(Material.COOKED_PORKCHOP, langConfig.getString("item.porkchopCooked.name", "Cooked Porkchop")));
        ...
        itemNames.add(new ItemName(Material.ENCHANTED_GOLDEN_APPLE, langConfig.getString("item.appleGold.name", "Enchanted Golden Apple")));
        itemNames.add(new ItemName(Material.SIGN, langConfig.getString("item.sign.name", "Sign")));
        itemNames.add(new ItemName(Material.OAK_DOOR, langConfig.getString("item.doorOak.name", "Oak Door")));
        ...
        itemNames.add(new ItemName(Material.SNOWBALL, langConfig.getString("item.snowball.name", "Snowball")));
        itemNames.add(new ItemName(Material.OAK_BOAT, langConfig.getString("item.boat.oak.name", "Oak Boat")));
        ...
        itemNames.add(new ItemName(Material.CHEST_MINECART, langConfig.getString("item.minecartChest.name", "Minecart with Chest")));
        itemNames.add(new ItemName(Material.FURNACE_MINECART, langConfig.getString("item.minecartFurnace.name", "Minecart with Furnace")));
        ...
        itemNames.add(new ItemName(Material.CLOCK, langConfig.getString("item.clock.name", "Clock")));
        itemNames.add(new ItemName(Material.GLOWSTONE_DUST, langConfig.getString("item.yellowDust.name", "Glowstone Dust")));
        itemNames.add(new ItemName(Material.COD, langConfig.getString("item.fish.cod.raw.name", "Cod")));
        itemNames.add(new ItemName(Material.SALMON, langConfig.getString("item.fish.salmon.raw.name", "Raw Salmon")));
        itemNames.add(new ItemName(Material.TROPICAL_FISH, langConfig.getString("item.fish.clownfish.raw.name", "Tropical Fish")));
        itemNames.add(new ItemName(Material.PUFFERFISH, langConfig.getString("item.fish.pufferfish.raw.name", "Pufferfish")));
        itemNames.add(new ItemName(Material.COOKED_COD, langConfig.getString("item.fish.cod.cooked.name", "Cooked Cod")));
        itemNames.add(new ItemName(Material.COOKED_SALMON, langConfig.getString("item.fish.salmon.cooked.name", "Cooked Salmon")));
        itemNames.add(new ItemName(Material.INK_SAC, langConfig.getString("item.dyePowder.black.name", "Ink Sac")));
        itemNames.add(new ItemName(Material.ROSE_RED, langConfig.getString("item.dyePowder.red.name", "Rose Red")));
        itemNames.add(new ItemName(Material.CACTUS_GREEN, langConfig.getString("item.dyePowder.green.name", "Cactus Green")));
        itemNames.add(new ItemName(Material.COCOA_BEANS, langConfig.getString("item.dyePowder.brown.name", "Cocoa Beans")));
        itemNames.add(new ItemName(Material.LAPIS_LAZULI, langConfig.getString("item.dyePowder.blue.name", "Lapis Lazuli")));
        itemNames.add(new ItemName(Material.PURPLE_DYE, langConfig.getString("item.dyePowder.purple.name", "Purple Dye")));
        itemNames.add(new ItemName(Material.CYAN_DYE, langConfig.getString("item.dyePowder.cyan.name", "Cyan Dye")));
        itemNames.add(new ItemName(Material.LIGHT_GRAY_DYE, langConfig.getString("item.dyePowder.silver.name", "Light Gray Dye")));
        itemNames.add(new ItemName(Material.GRAY_DYE, langConfig.getString("item.dyePowder.gray.name", "Gray Dye")));
        itemNames.add(new ItemName(Material.PINK_DYE, langConfig.getString("item.dyePowder.pink.name", "Pink Dye")));
        itemNames.add(new ItemName(Material.LIME_DYE, langConfig.getString("item.dyePowder.lime.name", "Lime Dye")));
        itemNames.add(new ItemName(Material.DANDELION_YELLOW, langConfig.getString("item.dyePowder.yellow.name", "Dandelion Yellow")));
        itemNames.add(new ItemName(Material.LIGHT_BLUE_DYE, langConfig.getString("item.dyePowder.lightBlue.name", "Light Blue Dye")));
        itemNames.add(new ItemName(Material.MAGENTA_DYE, langConfig.getString("item.dyePowder.magenta.name", "Magenta Dye")));
        itemNames.add(new ItemName(Material.ORANGE_DYE, langConfig.getString("item.dyePowder.orange.name", "Orange Dye")));
        itemNames.add(new ItemName(Material.BONE_MEAL, langConfig.getString("item.dyePowder.white.name", "Bone Meal")));
        ...
        itemNames.add(new ItemName(Material.REPEATER, langConfig.getString("item.diode.name", "Redstone Repeater")));
        ...
        itemNames.add(new ItemName(Material.BEEF, langConfig.getString("item.beefRaw.name", "Raw Beef")));
        itemNames.add(new ItemName(Material.COOKED_BEEF, langConfig.getString("item.beefCooked.name", "Steak")));
        itemNames.add(new ItemName(Material.CHICKEN, langConfig.getString("item.chickenRaw.name", "Raw Chicken")));
        ...
        itemNames.add(new ItemName(Material.NETHER_WART, langConfig.getString("item.netherStalkSeeds.name", "Nether Wart")));
        ...
        itemNames.add(new ItemName(Material.BREWING_STAND, langConfig.getString("item.brewingStand.name", "Brewing Stand")));
        itemNames.add(new ItemName(Material.CAULDRON, langConfig.getString("item.cauldron.name", "Cauldron")));
        itemNames.add(new ItemName(Material.ENDER_EYE, langConfig.getString("item.eyeOfEnder.name", "Eye of Ender")));
        itemNames.add(new ItemName(Material.GLISTERING_MELON_SLICE, langConfig.getString("item.speckledMelon.name", "Glistering Melon")));
        itemNames.add(new ItemName(Material.SKELETON_SPAWN_EGG, langConfig.getString("item.monsterPlacer.name", "Skeleton Spawn Egg")));
        // #todo add rest of mob eggs
        itemNames.add(new ItemName(Material.EXPERIENCE_BOTTLE, langConfig.getString("item.expBottle.name", "Bottle o' Enchanting")));
        itemNames.add(new ItemName(Material.FIRE_CHARGE, langConfig.getString("item.fireball.name", "Fire Charge")));
        itemNames.add(new ItemName(Material.WRITABLE_BOOK, langConfig.getString("item.writingBook.name", "Book and Quill")));
        ...
        itemNames.add(new ItemName(Material.FLOWER_POT, langConfig.getString("item.flowerPot.name", "Flower Pot")));
        itemNames.add(new ItemName(Material.CARROT, langConfig.getString("item.carrots.name", "Carrot")));
        itemNames.add(new ItemName(Material.POTATO, langConfig.getString("item.potato.name", "Potato")));
        ...
        itemNames.add(new ItemName(Material.MAP, langConfig.getString("item.emptyMap.name", "Empty Map")));
        itemNames.add(new ItemName(Material.GOLDEN_CARROT, langConfig.getString("item.carrotGolden.name", "Golden Carrot")));
        itemNames.add(new ItemName(Material.SKELETON_SKULL, langConfig.getString("item.skull.skeleton.name", "Skeleton Skull")));
        itemNames.add(new ItemName(Material.WITHER_SKELETON_SKULL, langConfig.getString("item.skull.wither.name", "Wither Skeleton Skull")));
        itemNames.add(new ItemName(Material.ZOMBIE_HEAD, langConfig.getString("item.skull.zombie.name", "Zombie Head")));
        itemNames.add(new ItemName(Material.PLAYER_HEAD, langConfig.getString("item.skull.char.name", "Head")));
        itemNames.add(new ItemName(Material.CREEPER_HEAD, langConfig.getString("item.skull.creeper.name", "Creeper Head")));
        itemNames.add(new ItemName(Material.WITHER_SKELETON_SKULL, langConfig.getString("item.skull.dragon.name", "Creeper Head")));
        itemNames.add(new ItemName(Material.CARROT_ON_A_STICK, langConfig.getString("item.carrotOnAStick.name", "Carrot on a Stick")));
        ...
        itemNames.add(new ItemName(Material.FIREWORK_ROCKET, langConfig.getString("item.fireworks.name", "Firework Rocket")));
        itemNames.add(new ItemName(Material.FIREWORK_STAR, langConfig.getString("item.fireworksCharge.name", "Firework Star")));
        itemNames.add(new ItemName(Material.ENCHANTED_BOOK, langConfig.getString("item.enchantedBook.name", "Enchanted Book")));
        itemNames.add(new ItemName(Material.COMPARATOR, langConfig.getString("item.comparator.name", "Redstone Comparator")));
        itemNames.add(new ItemName(Material.NETHER_BRICK, langConfig.getString("item.netherbrick.name", "Nether Brick")));
        itemNames.add(new ItemName(Material.QUARTZ, langConfig.getString("item.netherquartz.name", "Nether Quartz")));
        itemNames.add(new ItemName(Material.TNT_MINECART, langConfig.getString("item.minecartTnt.name", "Minecart with TNT")));
        ...
        itemNames.add(new ItemName(Material.IRON_HORSE_ARMOR, langConfig.getString("item.horsearmormetal.name", "Iron Horse Armor")));
        itemNames.add(new ItemName(Material.GOLDEN_HORSE_ARMOR, langConfig.getString("item.horsearmorgold.name", "Gold Horse Armor")));
        itemNames.add(new ItemName(Material.DIAMOND_HORSE_ARMOR, langConfig.getString("item.horsearmordiamond.name", "Diamond Horse Armor")));
        itemNames.add(new ItemName(Material.LEAD, langConfig.getString("item.leash.name", "Lead")));
        itemNames.add(new ItemName(Material.NAME_TAG, langConfig.getString("item.nameTag.name", "Name Tag")));
        itemNames.add(new ItemName(Material.COMMAND_BLOCK_MINECART, langConfig.getString("item.minecartCommandBlock.name", "Minecart with Command Block")));
        ...
        itemNames.add(new ItemName(Material.WHITE_BANNER, langConfig.getString("item.banner.black.name", "Black Banner")));
        itemNames.add(new ItemName(Material.RED_BANNER, langConfig.getString("item.banner.red.name", "Red Banner")));
        itemNames.add(new ItemName(Material.GREEN_BANNER, langConfig.getString("item.banner.green.name", "Green Banner")));
        itemNames.add(new ItemName(Material.BROWN_BANNER, langConfig.getString("item.banner.brown.name", "Brown Banner")));
        itemNames.add(new ItemName(Material.BLUE_BANNER, langConfig.getString("item.banner.blue.name", "Blue Banner")));
        itemNames.add(new ItemName(Material.PURPLE_BANNER, langConfig.getString("item.banner.purple.name", "Purple Banner")));
        itemNames.add(new ItemName(Material.CYAN_BANNER, langConfig.getString("item.banner.cyan.name", "Cyan Banner")));
        itemNames.add(new ItemName(Material.LIGHT_GRAY_BANNER, langConfig.getString("item.banner.silver.name", "Light Gray Banner")));
        itemNames.add(new ItemName(Material.GRAY_BANNER, langConfig.getString("item.banner.gray.name", "Gray Banner")));
        itemNames.add(new ItemName(Material.PINK_BANNER, langConfig.getString("item.banner.pink.name", "Pink Banner")));
        itemNames.add(new ItemName(Material.LIME_BANNER, langConfig.getString("item.banner.lime.name", "Lime Banner")));
        itemNames.add(new ItemName(Material.YELLOW_BANNER, langConfig.getString("item.banner.yellow.name", "Yellow Banner")));
        itemNames.add(new ItemName(Material.LIGHT_BLUE_BANNER, langConfig.getString("item.banner.lightBlue.name", "Light Blue Banner")));
        itemNames.add(new ItemName(Material.MAGENTA_BANNER, langConfig.getString("item.banner.magenta.name", "Magenta Banner")));
        itemNames.add(new ItemName(Material.ORANGE_BANNER, langConfig.getString("item.banner.orange.name", "Orange Banner")));
        itemNames.add(new ItemName(Material.WHITE_BANNER, langConfig.getString("item.banner.white.name", "White Banner")));
        itemNames.add(new ItemName(Material.SPRUCE_DOOR, langConfig.getString("item.doorSpruce.name", "Spruce Door")));
        itemNames.add(new ItemName(Material.BIRCH_DOOR, langConfig.getString("item.doorBirch.name", "Birch Door")));
        itemNames.add(new ItemName(Material.JUNGLE_DOOR, langConfig.getString("item.doorJungle.name", "Jungle Door")));
        itemNames.add(new ItemName(Material.ACACIA_DOOR, langConfig.getString("item.doorAcacia.name", "Acacia Door")));
        itemNames.add(new ItemName(Material.DARK_OAK_DOOR, langConfig.getString("item.doorDarkOak.name", "Dark Oak Door")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_11, langConfig.getString("item.record.11.name", "Music Disc")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_13, langConfig.getString("item.record.13.name", "Music Disc")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_BLOCKS, langConfig.getString("item.record.blocks.name", "Music Disc")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_CAT, langConfig.getString("item.record.cat.name", "Music Disc")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_CHIRP, langConfig.getString("item.record.chirp.name", "Music Disc")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_FAR, langConfig.getString("item.record.far.name", "Music Disc")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_MALL, langConfig.getString("item.record.mall.name", "Music Disc")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_MELLOHI, langConfig.getString("item.record.mellohi.name", "Music Disc")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_STAL, langConfig.getString("item.record.stal.name", "Music Disc")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_STRAD, langConfig.getString("item.record.strad.name", "Music Disc")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_WAIT, langConfig.getString("item.record.wait.name", "Music Disc")));
        itemNames.add(new ItemName(Material.MUSIC_DISC_WARD, langConfig.getString("item.record.ward.name", "Music Disc")));
        ...
        if (Utils.getMajorVersion() >= 9) {
            ...
            itemNames.add(new ItemName(Material.POPPED_CHORUS_FRUIT, langConfig.getString("item.chorusFruitPopped.name", "Popped Chorus Fruit")));
            ...
            itemNames.add(new ItemName(Material.DRAGON_BREATH, langConfig.getString("item.dragon_breath.name", "Dragon's Breath")));
            ...
            itemNames.add(new ItemName(Material.SPRUCE_BOAT, langConfig.getString("item.boat.spruce.name", "Spruce Boat")));
            itemNames.add(new ItemName(Material.BIRCH_BOAT, langConfig.getString("item.boat.birch.name", "Birch Boat")));
            itemNames.add(new ItemName(Material.JUNGLE_BOAT, langConfig.getString("item.boat.jungle.name", "Jungle Boat")));
            itemNames.add(new ItemName(Material.ACACIA_BOAT, langConfig.getString("item.boat.acacia.name", "Acacia Boat")));
            itemNames.add(new ItemName(Material.DARK_OAK_BOAT, langConfig.getString("item.boat.dark_oak.name", "Dark Oak Boat")));
        }

        if (Utils.getMajorVersion() >= 11) {
            // Add Item Names of 1.11
            itemNames.add(new ItemName(Material.TOTEM_OF_UNDYING, langConfig.getString("item.totem.name", "Totem of Undying")));
        ...
        if (Utils.getMajorVersion() >= 12) {
            ...
            itemNames.add(new ItemName(Material.WHITE_BED, langConfig.getString("item.bed.white.name", "White Bed")));
            itemNames.add(new ItemName(Material.ORANGE_BED, langConfig.getString("item.bed.orange.name", "Orange Bed")));
            itemNames.add(new ItemName(Material.MAGENTA_BED, langConfig.getString("item.bed.magenta.name", "Magenta Bed")));
            itemNames.add(new ItemName(Material.LIGHT_BLUE_BED, langConfig.getString("item.bed.lightBlue.name", "Light Blue Bed")));
            itemNames.add(new ItemName(Material.YELLOW_BED, langConfig.getString("item.bed.yellow.name", "Yellow Bed")));
            itemNames.add(new ItemName(Material.LIME_BED, langConfig.getString("item.bed.lime.name", "Lime Bed")));
            itemNames.add(new ItemName(Material.PINK_BED, langConfig.getString("item.bed.pink.name", "Pink Bed")));
            itemNames.add(new ItemName(Material.GRAY_BED, langConfig.getString("item.bed.gray.name", "Gray Bed")));
            itemNames.add(new ItemName(Material.LIGHT_GRAY_BED, langConfig.getString("item.bed.silver.name", "Light Gray Bed")));
            itemNames.add(new ItemName(Material.CYAN_BED, langConfig.getString("item.bed.cyan.name", "Cyan Bed")));
            itemNames.add(new ItemName(Material.PURPLE_BED, langConfig.getString("item.bed.purple.name", "Purple Bed")));
            itemNames.add(new ItemName(Material.BLUE_BED, langConfig.getString("item.bed.blue.name", "Blue Bed")));
            itemNames.add(new ItemName(Material.BROWN_BED, langConfig.getString("item.bed.brown.name", "Brown Bed")));
            itemNames.add(new ItemName(Material.GREEN_BED, langConfig.getString("item.bed.green.name", "Green Bed")));
            itemNames.add(new ItemName(Material.RED_BED, langConfig.getString("item.bed.red.name", "Red Bed")));
            itemNames.add(new ItemName(Material.BLACK_BED, langConfig.getString("item.bed.black.name", "Black Bed")));
        }
        ...
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_13, langConfig.getString("item.record.13.desc", "C418 - 13")));
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_CAT, langConfig.getString("item.record.cat.desc", "C418 - cat")));
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_BLOCKS, langConfig.getString("item.record.blocks.desc", "C418 - blocks")));
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_CHIRP, langConfig.getString("item.record.chirp.desc", "C418 - chirp")));
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_FAR, langConfig.getString("item.record.far.desc", "C418 - far")));
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_MALL, langConfig.getString("item.record.mall.desc", "C418 - mall")));
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_MELLOHI, langConfig.getString("item.record.mellohi.desc", "C418 - mellohi")));
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_STAL, langConfig.getString("item.record.stal.desc", "C418 - stal")));
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_STRAD, langConfig.getString("item.record.strad.desc", "C418 - strad")));
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_WARD, langConfig.getString("item.record.ward.desc", "C418 - ward")));
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_11, langConfig.getString("item.record.11.desc", "C418 - 11")));
        musicDiscNames.add(new MusicDiscName(Material.MUSIC_DISC_WAIT, langConfig.getString("item.record.wait.desc", "C418 - wait")));
    ...
    public static String getItemName(ItemStack stack) {
        ...
        for (ItemName itemName : itemNames) {
            // #todo re-evaluate mob egg logic
